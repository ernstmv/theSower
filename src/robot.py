...
class Robot:
    ...
    def robot_on(self):
        ...
        self.master.set_message('Robot conectado')
        self.unlock()
    ...
    def unlock(self):
        ...
        self.void_write('$X')
        self.master.set_message('Robot desbloqueado')
    ...
    def relative_mode(self):
        ...
        self.void_write('G91')
        self.absolute = False
        self.master.set_message('Coordenadas relativas')
    ...
    def absolute_mode(self):
        ...
        self.void_write('G90')
        self.absolute = True
        self.master.set_message('Coordenadas absolutas')
    ...
    def connect_robot(self):
        ...
        try:
            ...
            self.master.set_message(f'Puerto ocupado {self.port}')
    ...
    def autoconnect(self):
        ...
        if ports:
            ...
            self.master.set_message('No se han encontrado dispositivos seriales')
