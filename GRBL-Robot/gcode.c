...
uint8_t gc_execute_line(char *line)
{
        ...
        switch(int_value) {
          ...
          case 3: case 4: case 5:
            ...
            switch(int_value) {
              ...
              #endif
              case 8: gc_block.modal.coolant |= COOLANT_FLOOD_ENABLE; delay_ms(1000); break;
              case 9: gc_block.modal.coolant = COOLANT_DISABLE; delay_ms(1000); break; // M9 disables both M7 and M8.
            }
            break;
            ...
            //printPgmString(PSTR("Codigo G Activo\r\n"));
            printPgmString(PSTR(""));
            gc_block.modal.seeder = SEEDER_ACTIVE; break;
            case 16:
            word_bit = MODAL_GROUP_M10;
            gc_block.modal.seeder = MEASURE_DISTANCE; break;
          #endif
  ...
  */
  ...
  // [10.1 Seeder:]
  #ifdef SEEDER_CONFIG
    // gc_state.modal.seeder = gc_block.modal.seeder;//modif
    if(gc_block.modal.seeder == SEEDER_ACTIVE){
      limits_init();
      seederFinish = false;
      seederWorking = true;
      seeder_sync(SPINDLE_ENABLE_CW);
      //gc_block.modal.seeder = SEEDER_DEACTIVE;
      // return status;
    }
    if(gc_block.modal.seeder == MEASURE_DISTANCE){
      float distance_soil = 0.0;
      measure_distance(20, &distance_soil);
      printPgmString(PSTR("d:"));
      printFloat(distance_soil, 1);
      printPgmString(PSTR("cm\r\n"));
      //gc_block.modal.seeder = SEEDER_DEACTIVE;
    }
  #endif
  // [10. Dwell ]:
  ...
  if (gc_state.modal.program_flow) {
    ...
    if (gc_state.modal.program_flow == PROGRAM_FLOW_PAUSED) {
      ...
      #ifdef SEEDER_CONFIG
        gc_state.modal.seeder = SEEDER_DISABLED;
      #endif
