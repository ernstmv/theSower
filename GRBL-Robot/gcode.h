...
#define MODAL_GROUP_M10 15 ///[M15] Seeder Operation /**/
...
// Modal Group M10 Seeder Options
#ifdef SEEDER_CONFIG
    #define SEEDER_DISABLED 0
    #define SEEDER_ACTIVE 1 //[M15] Activa el seeder
    #define MEASURE_DISTANCE 2 //[M16] Medir distancia al suelo
#endif
