...
#define cpu_map_h
  ...
  #define Y_LIMIT_BIT      2  // Uno Digital Pin 10
    ...
    #ifdef SEEDER_CONFIG
        #define SENSOR_SEED 5 // Uno Digital Pin 13
        #define LIMIT_MASK2     ((1<<X_LIMIT_BIT)|(1<<Y_LIMIT_BIT)|(1<<Z_LIMIT_BIT)|(1<<SENSOR_SEED))
    #endif
  ...
  #define PROBE_MASK      (1<<PROBE_BIT)
    ...
    #define SPINDLE_INTERRUPT         TIMSK2 //Habilita la interrupcion de comparacion CTC

    // Prescaled, 8-bit Fast PWM mode.
    //*#define SPINDLE_TCCRA_INIT_MASK   ((1<<WGM20) | (1<<WGM21))  // Configures fast PWM mode.
    #define SPINDLE_TCCRA_INIT_MASK     (1<<WGM21)  // Configures CTC Mode
    // #define SPINDLE_TCCRB_INIT_MASK   (1<<CS20)               // Disable prescaler -> 62.5kHz
    // #define SPINDLE_TCCRB_INIT_MASK   (1<<CS21)               // 1/8 prescaler -> 7.8kHz (Used in v0.9)
    // #define SPINDLE_TCCRB_INIT_MASK   ((1<<CS21) | (1<<CS20)) // 1/32 prescaler -> 1.96kHz
    //*#define SPINDLE_TCCRB_INIT_MASK      (1<<CS22)               // 1/64 prescaler -> 0.98kHz (J-tech laser)
    #define SPINDLE_TCCRB_INIT_MASK      ((1<<CS22) | (1<<CS21) | (1<<CS20))  //* 1/1024 prescaler - 61Hz
    #define SPINDLE_TIMER_INTERRUPT_MASK    (1<<OCIE2A) //*
...
*/
...
#ifdef CPU_MAP_SEEDER_BOT // CPU of SEEDER BOT
  ...
  #ifdef SEEDER_CONFIG
      #define SENSOR_SEED 5 // Uno Digital Pin 13
      #define LIMIT_MASK2     ((1<<X_LIMIT_BIT)|(1<<Y_LIMIT_BIT)|(1<<Z_LIMIT_BIT)|(1<<SENSOR_SEED)) // All limit bits
  #endif
#define LIMIT_MASK     ((1<<X_LIMIT_BIT)|(1<<Y_LIMIT_BIT)|(1<<Z_LIMIT_BIT)) // All limit bits
#endif
